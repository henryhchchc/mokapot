...
impl<'a> ClassPrinter<'a> {
    ...
    pub const fn new(class: &'a Class, verbose: bool) -> Self {
        Self { class, verbose }
    }
...
fn print_method_details(method: &Method) {
    ...
    print_method_exceptions(method);
}
...
fn print_method_body(body: &MethodBody) {
    println!("    Code:");
...
fn print_method_exceptions(method: &Method) {
...
fn print_field_details(field: &Field) {
...
fn print_exception_table(body: &MethodBody) {
