...
pub(super) fn try_lift(
    ...
    use JVM::{
        ...
        FCmpG, FCmpL, FDiv, FMul, FNeg, FRem, FSub, I2B, I2C, I2D, I2F, I2L, I2S, IAdd, IAnd, IDiv,
        IMul, INeg, IOr, IRem, IShl, IShr, ISub, IUShr, IXor, L2D, L2F, L2I, LAdd, LAnd, LCmp,
        LDiv, LMul, LNeg, LOr, LRem, LShl, LShr, LSub, LUShr, LXor,
    };
    ...
    let instruction = match jvm_instruction {
        ...
        IUShr => lift_binary_math::<CATEGORY_1>(frame, value, MathOperation::LogicalShiftRight)?,
        ...
        L2D => lift_conversion::<CATEGORY_2, CATEGORY_2>(frame, value, Conversion::Long2Double)?,
        ...
        F2D => lift_conversion::<CATEGORY_1, CATEGORY_2>(frame, value, Conversion::Float2Double)?,
        D2I => lift_conversion::<CATEGORY_2, CATEGORY_1>(frame, value, Conversion::Double2Int)?,
        D2L => lift_conversion::<CATEGORY_2, CATEGORY_2>(frame, value, Conversion::Double2Long)?,
        D2F => lift_conversion::<CATEGORY_2, CATEGORY_1>(frame, value, Conversion::Double2Float)?,
