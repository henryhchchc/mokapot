...
impl Executor<'_> {
    pub(super) fn try_lift_constants(
        &mut self,
        jvm_instruction: &JVM,
        location: Location,
        ...
        use JVM::{
            AConstNull, BiPush, DConst0, DConst1, FConst0, FConst1, FConst2, IConst0, IConst1,
            IConst2, IConst3, IConst4, IConst5, IConstM1, LConst0, LConst1, Ldc, Ldc2W, LdcW,
            SiPush,
        };
